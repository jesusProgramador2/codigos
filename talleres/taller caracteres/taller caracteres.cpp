...
int main()
{
    ...
    char tabla[10][30];
    puts("programa que lee cadenas de caracteres e imprime la mas larga y la mas corta de la tabla rellenado");
    puts("ingrese cuantas cadenas de caracteres quiere poner max 10  ");
    scanf("%i",&cont);
